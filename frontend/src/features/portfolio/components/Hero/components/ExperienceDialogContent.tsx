    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      <GlassCard className="rounded-lg p-4 sm:p-5 glass-hover">
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="mt-1">
              <Badge
                variant="outline"
                className="text-[10px] sm:text-xs bg-accent-primary/10 text-accent-primary border-accent-primary/30"
              >
                Empresa
              </Badge>
            </div>
        ...
        <List as="ul" size="sm" className="mt-2">
          <ListItem>
            Fullstack: AngularJS • PHP • PostgreSQL, com foco em performance e
            integração.
          </ListItem>
          <ListItem>
      ...
      <GlassCard className="rounded-lg p-4 sm:p-5 glass-hover">
        ...
        <List as="ul" size="sm" className="mt-2">
          <ListItem>
            AngularJS • PHP • PostgreSQL, entregas ponta a ponta.
          </ListItem>

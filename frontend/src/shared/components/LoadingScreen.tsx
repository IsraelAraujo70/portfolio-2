          ...
          >
            ...
            <g mask="url(#mask0_21_7)">
              <rect
                ...
                width="521.819"
                height="260.815"
                transform="rotate(-43.8315 -93 102.38)"
                fill="#667678"
              />
              <rect
                x="-93"
              ...
              <rect
                ...
                height="260.815"
                transform="rotate(-43.8315 -93 102.38)"
                fill="url(#paint1_linear_21_7)"
              />
            </g>
            <defs>
              <radialGradient
                id="paint0_radial_21_7"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(167.909 232.788) rotate(90) scale(130.407 10.5733)"
              >
                <stop stopColor="#13E7AB" />
                <stop offset="1" stopColor="#23A8BF" stopOpacity="0.58" />
              </radialGradient>
              <linearGradient
                id="paint1_linear_21_7"
                x1="167.909"
                y1="102.38"
                x2="167.909"
                y2="363.195"
